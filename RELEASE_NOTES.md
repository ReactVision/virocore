...
Two platforms are new in this release: **Apple Vision Pro**, drawing through Metal into a CompositorServices immersive space, and **the web**, compiled to WebAssembly and drawing through WebGL2. With OpenGL ES on Android, Metal on iOS and OpenXR on Meta Quest, one renderer now covers five targets.
